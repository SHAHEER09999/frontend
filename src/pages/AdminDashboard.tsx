...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] bg-gray-100 pb-[60px] md:pb-0 font-sans antialiased">
      ...
      <div className="hidden md:flex w-64 bg-white border-r p-4 flex-col justify-between">
        ...
        <div className="border-t pt-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full bg-gray-800 hover:bg-black text-white py-2 rounded-lg transition duration-200"
          >
            <LogOut size={16} />
            Logout
          </button>
